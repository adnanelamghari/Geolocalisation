...
<div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"> LES UTILISATEURS DISPONIBLES</li>
      </ol>
      <div class="row">
        <div class="col-lg-4">
          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fa fa-search"></i><span> RECHERCHE</span></div>
            <div class="card-body">
              <form>
                <div class="form-group">
                  <label >Nom de Doctorant</label>
                  <input class="form-control"  type="text"  placeholder="Chercher Un Nom">
                </div>
                <div class="form-group">
                  <label >Ville</label>
                  <input class="form-control" type="text" placeholder="Chercher Une Ville">
                </div>
                <br>
                <button class="btn btn-primary btn-block hvr-underline-from-center" ><i class="fa fa-search"></i> Rechercher</button>
              </form>
            </div>
          </div>
        </div>
        <div class="col-lg-8">
          <div class="mb-3">
            ...
            <c:forEach items="${arrayDoc}" var="doctoranta">
              <div class="row"> 
                <div class="col-lg-12 panels">
                  <table style="background-color: #e9ecef;" class="col-lg-12">
                    <tr>
                      <td><img src="./profil_pics/<c:out value='${!empty doctoranta.pictureName ? doctoranta.pictureName : "no-img-user.png"}' />" class="rounded-circle hvr-pulse-grow" width="80" height="80" style="margin: 12px;"></td>
                      <td><c:out value="${doctoranta.nom}" /> <c:out value="${doctoranta.prenom}" />
                        <p class="font-khfif"><c:out value="${doctoranta.biographie}" /></p><hr>
                        <p class="font-khfif"><c:out value="${doctoranta.mail}" /></p>
                      </td>
                    </tr>
                  </table>
                  <div class="row" >
                    <div class="d-block col-lg-6"><a href="./profile?doctorant=<c:out value='${ doctoranta.userName}' />" class="btn btn-primary btn-block "><i class="fa fa-eye"></i> Visiter Profil</a></div>
                    <div class="d-block col-lg-6"><a href="./chat?doctorant=<c:out value='${ doctoranta.userName}' />" class="btn btn-primary btn-block "><i class="fa fa-fw fa-comments"></i> Contacter</a></div>
                  </div>
                </div>                
              </div>
              <br>
    ...
    <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small>Copyright ï¿½ Groupe 3-3</small>
        </div>
      </div>
    </footer>
